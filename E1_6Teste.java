...
math faz parte do pacote java.lang
todos os métodos da classe Math são estáticos, podemos chamá-los diretamente usando o Math.nomeDoMetodo() sem precisar criar uma instância da classe (sem criar um objeto)
*/
